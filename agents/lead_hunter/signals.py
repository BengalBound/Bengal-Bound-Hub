...
def provision_lead_hunter_instance(sender, instance, created, **kwargs):
    if not getattr(instance, 'agent_catalog', None) or instance.agent_catalog.slug != 'lead_hunter':
        return
