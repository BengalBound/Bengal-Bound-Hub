...
def provision_reporting_bot_instance(sender, instance, created, **kwargs):
    if not getattr(instance, 'agent_catalog', None) or instance.agent_catalog.slug != 'reporting_bot':
        return
