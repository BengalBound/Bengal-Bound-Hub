...
def provision_voice_receptionist_instance(sender, instance, created, **kwargs):
    if not getattr(instance, 'agent_catalog', None) or instance.agent_catalog.slug != 'voice_receptionist':
        return
