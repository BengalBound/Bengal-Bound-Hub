...
SITE_ID = 1
SITE_DOMAIN = env('SITE_DOMAIN', default='bengalbound.com')
...
# In production.py, we will override this to point to Memorystore Redis.
# For local development or tests without Redis, use InMemoryChannelLayer.
